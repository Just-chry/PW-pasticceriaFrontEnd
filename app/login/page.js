                ...
                <div className={styles.containerRegister}>
                    ...
                    <form className={styles.form}>
                        ...
                        <div className={styles.inputForm}>
                            ...
                            <input type="password" id="password" name="password" className={styles.input} placeholder="Inserisci la tua Password" required />
                        </div>

                        <div className={styles.flexPassword}>
                            <Link href="/forgot-password" className={styles.spanPassword}>Passowrd dimenticata?</Link>
                        </div>
