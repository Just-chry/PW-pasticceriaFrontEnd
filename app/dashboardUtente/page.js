...
export default function Dashboard() {
    ...
    const [newPhone, setNewPhone] = useState('+39');
                            ...
                            {user.phone ? (
                                ...
                                <div className={styles.inputFormEmailTel}>
                                    ...
                                    <input
                                        type="tel"
                                        value={newPhone}
                                        onChange={(e) => setNewPhone(e.target.value.startsWith('+39') ? e.target.value : '+39' + e.target.value)}
                                        placeholder="Aggiungi telefono"
                                        className={styles.inputEmailTel}
                                    />
                                    <button className={styles.buttonEmailTel} onClick={handleSavePhone}>Aggiungi
                                    </button>
                                </div>
                            )}
                        </div>
