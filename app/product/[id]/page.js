    ...
    <div>
      ...
      <div className={styles.productContainer}>
        <div className={styles.productImageWrapper}>
          <img src={`/images/${product.image}`} alt={product.nome} width={800} height={600} className={styles.productImage} />
        </div>
        <div className={styles.productDetails}>
          ...
          <div className={styles.ingredientsAndAllergens}>
            <p className={styles.productingredients}><span>Ingredienti:</span> {product.ingredients}</p>
          </div>
