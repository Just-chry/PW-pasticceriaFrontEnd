    ...
    <header className={styles.header}>
      ...
      <nav className={`${styles.nav} ${menuOpen ? styles.open : ''}`}>
        <ul>
          ...
          <li className={styles.desktopOnly}>
            <Link href="/magazzino" className={path === "/magazzino" ? `${styles.link} ${styles.active}` : styles.link}>Magazzino</Link>
          </li>
          <li className={styles.desktopOnly}>
            <Link href="/ordiniAdmin" className={path === "/ordiniAdmin" ? `${styles.link} ${styles.active}` : styles.link}>Ordini</Link>
          </li>
